...
namespace MIS4200_CentricProject_Team12.Controllers
{
    public class recognitionDetailsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.recognitionId = new SelectList(db.Recognitions, "recognitionId", "recognizedBy");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "recognitionDetailsId,employeeId,explanation,recognizedby,recognitionId")] recognitionDetails recognitionDetails)
        {
            ...
            ViewBag.recognitionId = new SelectList(db.Recognitions, "recognitionId", "recognizedBy", recognitionDetails.recognitionId);
            return View(recognitionDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "recognitionDetailsId,employeeId,explanation,recognizedby,recognitionId")] recognitionDetails recognitionDetails)
        {
            if (ModelState.IsValid)
            {
