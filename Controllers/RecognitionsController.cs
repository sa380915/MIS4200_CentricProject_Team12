...
namespace MIS4200_CentricProject_Team12.Controllers
{
    public class RecognitionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "recognitionId,recognitionTitle,description,recognitionPoints")] Recognition recognition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "recognitionId,recognitionTitle,description,recognitionPoints")] Recognition recognition)
        {
            if (ModelState.IsValid)
            {
